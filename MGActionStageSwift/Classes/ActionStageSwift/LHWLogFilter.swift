...
public protocol LHWFilterType : class {
    ...
    func reachedMinLevel(_ level: MGActionStageSwift.Level) -> Bool
}
...
public class LHWFilter {
    ...
    let required: Bool
    let minLevel: MGActionStageSwift.Level
    
    public init(_ target: LHWFilter.TargetType, required: Bool, minLevel: MGActionStageSwift.Level) {
    ...
    public func reachedMinLevel(_ level: MGActionStageSwift.Level) -> Bool {
...
public class CompareFilter: LHWFilter, LHWFilterType {
    ...
    override public init(_ target: LHWFilter.TargetType, required: Bool, minLevel: MGActionStageSwift.Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: MGActionStageSwift.Level = .verbose) -> LHWFilterType {
